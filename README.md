...
The platform combines heterogeneous data sources, including:

* Electronic Health Records (EHRs)
* Public health surveillance data
* Wastewater monitoring data
* Mobile health clinic records
* Demographic and socioeconomic datasets

By integrating these data streams, DMA-PRIME enables public health professionals to monitor disease activity, identify emerging outbreaks, forecast future trends, and support evidence-based decision-making.
