...
function addHealthFacilityLayer(targetMap, maps, values) {
  ...
  const symbolIcon = `
    ...
    `;
  // const markerIcon = `<svg xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="423.44 302.24 264.14 358.08"><path d="M534.1 303.5c-10.2 2-29.3 8.1-36.6 11.7-38 19.1-63 52-72.2 94.8-2.5 11.9-2.5 38.1.1 50 4.6 21.4 11.5 36.7 24.7 55 15.6 21.6 41.3 57.5 71.7 100 16.7 23.4 31.2 43.3 32.2 44.3 1.9 2.1.3 4.1 23.5-28.3 6.5-9.1 14.6-20.3 18-25s16.3-22.5 28.5-39.5c12.3-17.1 27.4-38 33.6-46.5 16.3-22.5 23.4-37.7 28.1-60 2.5-11.8 2.5-38.2 0-50-8.5-39.5-29.5-69.3-63.3-89.6-11.2-6.7-22.4-11.2-37.9-15.1-12.7-3.1-38.5-4.1-50.4-1.8m48.1 22.3c39.8 10.6 70 39.9 81.2 78.6 15.1 51.8-10 107.9-58.8 131.6-19 9.2-36.8 12.6-57.9 10.9-16.1-1.3-26.6-4.3-41.4-11.8-29.5-14.9-50.2-40.9-58.2-73.1-2.7-10.6-3.3-15.7-3.2-27.8.2-51.5 36.3-96.7 86.6-108.5 10.9-2.6 11.1-2.6 28-2.2 12.2.2 17.8.8 23.7 2.3"/></svg>`
  ...
  symbolImg.onload = () => {
    try {
      if (!targetMap.hasImage || !targetMap.hasImage("health-system")) {
        targetMap.addImage("health-system", symbolImg, { sdf: true });
      }
    } catch (err) {
