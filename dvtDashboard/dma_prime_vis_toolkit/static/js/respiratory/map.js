    ...
    d3.json("/data/map/county").then(function(mapdata) {
        ...
        d3.json("/data/map/zcta").then(function(mapdata) {
            ...
            mapdata.features.forEach(function(data) {
                group = zctas.select(`#map-${data.properties.ZCTA}-group`)
                element = group.datum()
        ...
        d3.csv("/data/health-care-facility/hospitals").then(function(hospdata){
        ...
        d3.csv("/data/health-care-facility/mobile_health_clinics").then(function(clinicData){
        ...
        d3.csv("/data/health-care-facility/all_community_partners").then(function(clinicData){
