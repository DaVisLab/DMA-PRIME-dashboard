    ...
    d3.json("/map-data/zcta").then(function(mapdata) {
        ...
        d3.json("/get-hospital-zcta-data", { // zcta hospital data
                ...
                .each(function(d) {
                    ...
                    svg.append("g")
                        ...
                        .selectAll("g")
                            ...
                            .enter()
                            .append("g")
                            .attr("id", d => `${disease}-map-${d.properties.ZCTA}-group`)
                            .attr("class", d => `comparison-zcta-group _${d.properties.ZCTA}`)
                            .each(function(d) {
                                setupComparisonTooltip(this)

                                zcta = d.properties.ZCTA
            ...
            d3.selectAll(".comparison-zctas").selectAll("path").each(function(d) {
                ...
                lon = fixCoord(d.properties.INTPTLON)
                lat = fixCoord(d.properties.INTPTLAT)
