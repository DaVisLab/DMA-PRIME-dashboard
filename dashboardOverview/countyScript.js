...
const countyUppercase = currentCounty[0].toUpperCase() + currentCounty.slice(1);
console.log(currentUrl, currentCounty);

d3.csv("/DMA-PRIME-dashboard/dashboardOverview/Counties daily cases/" + currentCounty + "_case_daily.csv").then(
  function (data) {

    d3.csv("/DMA-PRIME-dashboard/dashboardOverview/RealDataCounties/" + currentCounty.toUpperCase() + "covid19.csv").then(function (real_data) {
